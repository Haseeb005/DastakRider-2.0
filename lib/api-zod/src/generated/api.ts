...
export const GetAvailableOrdersResponseItem = zod.object({
  ...
  "riderFare": zod.number().optional().describe('The rider\'s payout for this order (per-order snapshot locked at accept time). This is the rider\'s earnings, distinct from deliveryFee.'),
