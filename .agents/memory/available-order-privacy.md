...
**How to apply:** Enforce the restricted shape in the available-orders API and new-order push payload, use a distinct client contract for available orders, and keep full order responses behind successful assignment to that rider.