...
- [Rider acceptance anti-automation](rider-acceptance-anti-automation.md) — normal order acceptance stays one tap; extra confirmation is reserved for server-detected suspicious patterns.
